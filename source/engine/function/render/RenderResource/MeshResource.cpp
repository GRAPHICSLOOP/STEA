...
{
	mMeshBufferResource.mVertexResource = VertexResource::create(vertices.data(), (uint32_t)vertices.size(), {VertexAttribute::VA_Position,VertexAttribute::VA_Color,VertexAttribute::VA_UV0});
