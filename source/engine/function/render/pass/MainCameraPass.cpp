...
void MainCameraPass::setupDescriptorSetLayout()
{
    ...
    mDescSetLayouts[0] = gRuntimeGlobalContext.getRenderResource()->mUniformResource->mDescSetLayout;
    mDescSetLayouts[1] = gRuntimeGlobalContext.getRenderResource()->getDescriptorSetLayout(DESCRIPTOR_TYPE::DT_Sample);
}
